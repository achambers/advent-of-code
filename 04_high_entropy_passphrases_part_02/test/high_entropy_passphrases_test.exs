defmodule HighEntropyPassphrasesTest do
  ...
  test "examples" do
    assert HighEntropyPassphrases.valid?("abcde fghij") == true
    assert HighEntropyPassphrases.valid?("a ab abc abd abf abj") == true
    assert HighEntropyPassphrases.valid?("iiii oiii ooii oooi oooo") == true

    assert HighEntropyPassphrases.valid?("abcde xyz ecdab") == false
    assert HighEntropyPassphrases.valid?("oiii ioii iioi iiio") == false
  end
  ...
  test "input" do
    ...
    """
    assert HighEntropyPassphrases.count_valid(input) == 231
  end
end
